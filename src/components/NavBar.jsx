    ...
    <header className='header'>
        <div className="header-nav">
          <a className="logo-nav" href="/">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-mouse-pointer-click h-6 w-6 text-primary">
          ...
          <nav className="navigation-links">
            ...
            <a className="navigation-button" href="/about">About</a>
            <a className="navigation-button" href="/events">Events</a>
            <a className="navigation-button" href="/blogs">Blogs</a>
            <a className="navigation-button" href="/contact">Contact</a>
          </nav>
          <div className="">
            <a className="" href="/admin">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-circle-user-round h-6 w-6"><path d="M18 20a6 6 0 0 0-12 0"></path><circle cx="12" cy="10" r="4"></circle>
